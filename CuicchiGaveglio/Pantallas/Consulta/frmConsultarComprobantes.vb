Public Class frmConsultarComprobantes
    ...
    Public Sub CambiarColorFilas()
        ...
        For Each fila As DataGridViewRow In DComprobantes.Rows
            ...
            ElseIf (fila.Cells.Item("Tipo_Comprobante").Value = "Cheque" Or fila.Cells.Item("Tipo_Comprobante").Value = "Transferencia") And (fila.Cells.Item("Estado").Value <> "Enviado Compania") Then
                fila.DefaultCellStyle.BackColor = Color.LightSalmon
            Else
                fila.DefaultCellStyle.BackColor = Color.LightGreen
            End If
    ...
    Public Sub setearValoresCombo()
        ...
        DFIngresoDesdeFiltro.Value = DFIngresoHastaFiltro.Value.AddDays(-1)
    ...
    Private Sub frmConsultarComprobantes_Closed(sender As Object, e As EventArgs) Handles Me.Closed
