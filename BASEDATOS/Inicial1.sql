...
CREATE FUNCTION dc(@date DATETIME)  
RETURNS VARCHAR   
AS   
BEGIN    
    RETURN CONVERT(varchar,@date,3);  
END; 
...
(
idCobrador SMALLINT PRIMARY KEY IDENTITY(1,1),
nombreCobrador varchar(25) NOT NULL
)
...
obs varchar(MAX),
idCobrador SMALLINT,
CONSTRAINT fk_ClienteCobrador FOREIGN KEY (idCobrador) REFERENCES Cobradores (idCobrador),
)
...
(
idPlanilla INT IDENTITY(1,1),
idCliente SMALLINT NOT NULL,
fPlanilla INT NOT NULL,
...
fIngreso INT NOT NULL,
idCliente SMALLINT NOT NULL,
importe money NOT NULL,
idEstado tinyint NOT NULL,
idUsuario tinyint NOT NULL,
idEstadoOperacion tinyint NOT NULL,
idCompania SMALLINT NOT NULL, --No puede ser nula ya que es clave foranea, pero no siempre va a estar (aca voy a poner el valor 0)
idBanco INT NOT NULL, --No puede ser nula ya que es clave foranea, pero no siempre va a estar (aca voy a poner el valor 0)

fPago INT NULL,
numero varchar(25) NULL,
obs varchar(100) NULL,
obsBaja varchar(100) NULL,
Tomador VARCHAR(25) NULL,
Ref VARCHAR (25) NULL, 
Detalle VARCHAR(50) NULL ,
Patente VARCHAR(20) NULL,
FVencimiento INT NULL,
idPlanilla INT NULL,
...
INSERT INTO Cobradores(nombreCobrador) VALUES ('N')
